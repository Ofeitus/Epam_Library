-- Roles
INSERT INTO `libraryTest`.`users_roles` (`role_id`, `role_name`) VALUES
    ('1', 'ADMIN'),
    ('2', 'MANAGER'),
    ('3', 'MEMBER');

-- Users
INSERT INTO `libraryTest`.`users` (user_id, registration_date, name, surname, phone_number, email, password_hash, role_id, deleted) VALUES
...
-- Book Categories
INSERT INTO `libraryTest`.`book_categories` (`category_id`, `category_name`) VALUES
    ('0', 'Художественная литература'),
    ('0', 'Учебное пособие');

-- Authors
INSERT INTO `libraryTest`.`authors` (`author_id`, `name`, `surname`) VALUES
    ('0', 'Джоан', 'Роулинг'),
    ('0', 'Игорь', 'Мытько'),
    ('0', 'Андрей', 'Жвалевский'),
    ('0', 'Рэй', 'Брэдбери'),
...
-- Books
INSERT INTO `libraryTest`.`books` (`book_isbn`, `title`, `publication_year`, `category_id`, `language`, `key_words`) VALUES
...
-- Book has Author
INSERT INTO `libraryTest`.`book_has_author` (book_isbn, author_id) VALUES
    ('9785389074354', '1'),
    ('9785389077812', '1'),
    ('9785389077881', '1'),
    ('9785389077898', '1'),
...
INSERT INTO `libraryTest`.`copy_of_book_status` (copy_of_book_status_id, copy_of_book_status_value) VALUES
    ('1', 'AVAILABLE'),
    ('2', 'READING_ROOM'),
    ('3', 'RESERVED'),
    ('4', 'LOANED'),
...
-- Copies of Books
INSERT INTO `libraryTest`.`copies_of_books` (inventory_id, receipt_date, price, book_isbn, copy_of_book_status_id) VALUES
...
-- Loan statuses
INSERT INTO `libraryTest`.`loan_status` (loan_status_id, loan_status_value) VALUES
    ('1', 'ISSUED'),
    ('2', 'RETURNED'),
    ('3', 'FINED'),
    ('4', 'PAID');
...
-- Loans
INSERT INTO `libraryTest`.`loans` (loan_id, issue_date, due_date, return_date, fine_amount, user_id, inventory_id, loan_status_id) VALUES
    ...
    ('0', '2020-02-20', '2020-02-20', '2020-02-20', '2', '3', '5', '3');

-- Reservation statuses
INSERT INTO `libraryTest`.`reservation_status` (reservation_status_id, reservations_status_value) VALUES
    ('1', 'RESERVED'),
    ('2', 'READY_TO_ISSUE'),
    ('3', 'ISSUED');

-- Reservations
INSERT INTO `libraryTest`.`reservations` (reservation_id, date, user_id, inventory_id, reservation_status_id) VALUES
