...
public class GoToAccountsPageCommand implements Command {
    private final Logger logger = LogManager.getLogger(GoToAccountsPageCommand.class);
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String command = "?" + RequestParameter.COMMAND + "=" + CommandName.GOTO_ACCOUNTS_PAGE_COMMAND;
            ...
            List<Account> accounts = accountService.getAllAccounts(page, itemsOnPage);

            int itemsCount = accountService.countAllAccounts();
            ...
            return new CommandResult(Page.ACCOUNTS_PAGE, RoutingType.FORWARD);
