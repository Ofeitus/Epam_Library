...
public class GoToAddCreditPageCommand implements Command {
    private final Logger logger = LogManager.getLogger(GoToAddCreditPageCommand.class);
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String command = "?" + RequestParameter.COMMAND + "=" + CommandName.GOTO_ADD_CREDIT_PAGE_COMMAND;
            ...
            return new CommandResult(Page.ADD_CREDIT_PAGE, RoutingType.FORWARD);
