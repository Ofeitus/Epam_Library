...
INSERT INTO `library`.`books` (`isbn`, `title`, `publication_year`, `category_id`, `language`, `key_words`) VALUES ('9785389077881', 'Гарри Поттер и узник Азкабана', '2016', '1', 'Русский', 'Фентези');
